  ...
  <div class="panel admin-panel">
    ...
    <table class="table table-hover text-center">
      ...
      <?php
        ...
        $sql1 = "select count(0) size from activity";
        ...
        $sql2 = "select activity.aid, activity.apic, activity.atitle, activity.adate, activity.ainfo from activity limit $start, $pageSize";
...
<script type="text/javascript">
  ...
  function del(id,mid,iscid){
    if(confirm("您确定要删除吗?")){
          window.location.href="delete.php?tname=activity&id="+id;
    }else{
          alert(1);
      }
  }
  ...
  $(function(){
    ...
    $("#lists > a").click(function(){
      ...
      $.post("listActivity.php", {"clickPage":clickPage}, function(data){
        $("form").html("");
        $("form").html(data);
      });
    });
  ...
  // 修改
  function doModify(x) {
    window.location.href = "edit.php?tname=activity&id="+x;
  }
